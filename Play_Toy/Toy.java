        ...
        switch (choice) {
            ...
            case 1:
                ...
                try (BufferedWriter fileWriter = Files.newBufferedWriter(Paths.get("WeightOfToys.log"), StandardCharsets.UTF_8, StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING)) {
                    ...
                    System.out.println("Введите \"id наименование частоту количество через пробел\". По окончании, введите \"exit\"");
                    ...
                    while (true) {
                        ...
                        if (data.length != 4) {
                            ...
                            System.out.println("Некорректный ввод. Ожидается id наименование количество частота. либо \"exit\"");
                        ...
                        try {
                            ...
                            System.out.println("Некорректный ввод. Ожидается id наименование количество частота. либо \"exit\"" + e.getMessage());
            ...
            case 2:
                ...
                int[] quantity = new Random().ints(size, 1, upperBound).toArray();
            ...
            case 3:
                ...
                if (Files.size(Paths.get("WeightOfToys.log")) > 0) {
                    ...
                    System.out.println("Файл не пустой. Введите данные для новых игрушек > по окончании ввода, добавьте exit");
                    ...
                    System.out.println("Файл пустой. Добавьте данные с использованием пункта 1, 2, 3.");
                ...
                if (Files.size(Paths.get("WeightOfToys.log")) > 0) {
                    ...
                    if (!selectedToys.isEmpty()) {
                        ...
                        if (updatedQuantity <= 0) {
                            ...
                            try (BufferedReader reader = Files.newBufferedReader(Paths.get("WeightOfToys.log"), StandardCharsets.UTF_8)) {
                                ...
                                while ((line = reader.readLine()) != null) {
                                    ...
                                    if (currentId != selectedToy.getId()) {
                            ...
                            Files.write(Paths.get("WeightOfToys.log"), updatedLines, StandardCharsets.UTF_8, StandardOpenOption.TRUNCATE_EXISTING);

                            System.out.println("\nДарим вам единственную позицию, таких больше нет!!!");
                        ...
                        try (BufferedWriter writer = Files.newBufferedWriter(Paths.get("WeightOfToys.log"), StandardCharsets.UTF_8, StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING)) {
                            ...
                            for (String line: lines) {
                                ...
                                if (id == selectedToy.getId()) {

                                    int quantityf = Integer.parseInt(data[2]);
                                    ...
                                    line = String.format("%d %s %d %.4s", id, data[1], quantityf, Double.parseDouble(data[3].replace(",", ".")));
